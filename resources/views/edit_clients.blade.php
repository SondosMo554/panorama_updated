    ...
    <div class="edit-client-form">
        ...
        <form action="{{ route('clients.update', $client->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="title" id="title" value="{{ $client->title }}" required>
            </div>
            ...
            <div class="form-group">
                ...
                <div id="image-preview">
                    <img id="preview" src="{{ asset('images/' . $client->image) }}" width="100" alt="Image Preview">
                </div>
            </div>

            <div class="form-group">
                <label for="description">الوصف</label>
                <textarea class="form-control" name="description" id="description" required>{{ $client->description }}</textarea>
            </div>
