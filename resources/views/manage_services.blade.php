...
<div id="container">
    <div id="main">
        ...
        <a href="{{ route('services.create') }}" class="btn">إضافة خدمة جديدة</a>
            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><img src="{{ asset('images/' . $service->image) }}" alt="{{ $service->title }}"></td>
                        ...
                        <td>
                            <a href="{{ route('services.edit', $service->id) }}" class="btn">تعديل</a>
                            <form action="{{ route('services.destroy', $service->id) }}" method="POST" style="display:inline;">
                                @csrf
                                @method('DELETE')
                                <button type="submit" class="btn btn-danger"onclick="return confirm('Are you sure you want to delete this service?')">حذف</button>
                            </form>
                        </td>
                    </tr>
                    @endforeach
